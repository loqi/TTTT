...
* `:IP6` (border) links are mediated by actual TTTT wads over IP datagrams.
...
represents a dunbar link between a foreign and domestic node, thus requiring IPv6 datagrams or similar
